...
echo -e "${RED}│  \033[0m ${WHITE} $ssh1        $vma           $vla          $tra               $ssa   $NC    ${RED}│"
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                     << MENU TUNNELING >>                    \E[0m" | lolcat    
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "   ${CYAN}[01]${BLUE}•${NC} ${YELLOW}SSH${NC}        ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[08]${BLUE}•${NC}${YELLOW} BACKUP${NC}     ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${CYAN}[02]${BLUE}•${NC} ${YELLOW}VMESS${NC}      ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[09]${BLUE}•${NC}${YELLOW} SETTING${NC}    ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${CYAN}[03]${BLUE}•${NC} ${YELLOW}VLESS${NC}      ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[10]${BLUE}•${NC}${YELLOW} INFORMATION${NC}${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${CYAN}[04]${BLUE}•${NC} ${YELLOW}TROJAN${NC}     ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[11]${BLUE}•${NC}${YELLOW} ADD DOMAIN${NC} ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${CYAN}[05]${BLUE}•${NC} ${YELLOW}SDSK${NC}       ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[12]${BLUE}•${NC}${YELLOW} CERT XRAY${NC}  ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${CYAN}[06]${BLUE}•${NC} ${YELLOW}UPDATE${NC}     ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[13]${BLUE}•${NC}${YELLOW} AUTO REBOOT${NC}${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${CYAN}[07]${BLUE}•${NC} ${YELLOW}INSTALL UDP${NC}${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${CYAN}[14]${BLUE}•${NC}${YELLOW} BOT${NC}        ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
