...
echo -e "  ${BLUE}• ${GREEN}Clients Name        ${NC}= ${LIGHT}$Name ${NC}"
echo -e "  ${BLUE}• ${GREEN}Script Expired      ${NC}= ${LIGHT}$Exp ${NC}"
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= ${LIGHT}YogzVPN Tunneling ${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                     << STATUS SERVICE >>                    \E[0m" | lolcat    
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "      ${COLOR2}[ SSH Websocket${NC}: ${LIGHT}ON ]${NC} [ NGINX${NC}: ${status_nginx} ] [ XRAY${NC} : ${status_xray} ] "
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "${RED}│  \033[0m ${BOLD}${YELLOW}SSH     VMESS       VLESS      TROJAN       SHADOWSOCKS$NC  ${RED}│"
echo -e "${RED}│  \033[0m ${LIGHT} $ssh1        $vma           $vla          $tra               $ssa   $NC    ${RED}│"
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "                     << MENU TUNNELING >>                    \E[0m" | lolcat    
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "   ${LIGHT}[01]${BLUE}•${NC} ${YELLOW}SSH${NC}        ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[08]${BLUE}•${NC}${YELLOW} BACKUP${NC}     ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "   ${LIGHT}[02]${BLUE}•${NC} ${YELLOW}VMESS${NC}      ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[09]${BLUE}•${NC}${YELLOW} SETTING${NC}    ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "   ${LIGHT}[03]${BLUE}•${NC} ${YELLOW}VLESS${NC}      ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[10]${BLUE}•${NC}${YELLOW} INFORMATION${NC}${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "   ${LIGHT}[04]${BLUE}•${NC} ${YELLOW}TROJAN${NC}     ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[11]${BLUE}•${NC}${YELLOW} ADD DOMAIN${NC} ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "   ${LIGHT}[05]${BLUE}•${NC} ${YELLOW}SDSK${NC}       ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[12]${BLUE}•${NC}${YELLOW} CERT XRAY${NC}  ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "   ${LIGHT}[06]${BLUE}•${NC} ${YELLOW}UPDATE${NC}     ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[13]${BLUE}•${NC}${YELLOW} AUTO REBOOT${NC}${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "   ${LIGHT}[07]${BLUE}•${NC} ${YELLOW}INSTALL UDP${NC}${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}         ${LIGHT}[14]${BLUE}•${NC}${YELLOW} BOT${NC}        ${LIGHT}[${NC}${LIGHT}MENU${NC}${LIGHT}]${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
