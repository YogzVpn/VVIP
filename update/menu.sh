...
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "   ${LIGHT}[01]${BLUE}•${NC} ${CYAN}SSH${NC}        ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}         ${LIGHT}[08]${BLUE}•${NC}${CYAN} BACKUP${NC}     ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}"
echo -e "   ${LIGHT}[02]${BLUE}•${NC} ${CYAN}VMESS${NC}      ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}         ${LIGHT}[09]${BLUE}•${NC}${CYAN} SETTING${NC}    ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}"
echo -e "   ${LIGHT}[03]${BLUE}•${NC} ${CYAN}VLESS${NC}      ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}         ${LIGHT}[10]${BLUE}•${NC}${CYAN} INFORMATION${NC}${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}"
