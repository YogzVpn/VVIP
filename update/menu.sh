...
echo -e "${CYAN}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "  ${LIGHT}• ${CYAN}Server Uptime       ${NC}=${GREEN} $( uptime -p  | cut -d " " -f 2-10000 ) "
echo -e "  ${LIGHT}• ${CYAN}Current Time        ${NC}=${GREEN} $( date -d "0 days" +"%d-%m-%Y | %X" )"
echo -e "  ${LIGHT}• ${CYAN}Operating System    ${NC}=${GREEN} $( cat /etc/os-release | grep -w PRETTY_NAME | sed 's/PRETTY_NAME//g' | sed 's/=//g' | sed 's/"//g')( $(uname -m))"
echo -e "  ${LIGHT}• ${CYAN}Domain/Host         ${NC}=${GREEN} $( cat /etc/xray/domain )"
echo -e "  ${LIGHT}• ${CYAN}Server IP           ${NC}=${GREEN} ${IP}"
echo -e "  ${LIGHT}• ${CYAN}ISP-VPS             ${NC}=${GREEN} ${ISP}"
echo -e "  ${LIGHT}• ${CYAN}City                ${NC}=${GREEN} ${CITY}"
...
echo -e "${CYAN}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "      ${LIGHT}[ ${GREEN}SSH Websocket${NC}${LIGHT}: ON ]${NC} ${LIGHT}[ ${GREEN}NGINX${NC}${LIGHT}: ${status_nginx} ] ${LIGHT}[ ${GREEN}XRAY${NC}${LIGHT}: ${status_xray} ] "
echo -e "${CYAN}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "${CYAN}┌────────────────────────────────────────────────────────────┐${NC}"
...
echo -e "   ${CYAN}[${LIGHT}04${CYAN}]${RED}•${NC} ${CYAN}TROJAN${NC}     ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}11${CYAN}]${RED}•${NC}${CYAN} ADD DOMAIN${NC} ${CYAN}[${NC}${YELLOW}MENU${NC}${CYAN}]${NC}"
