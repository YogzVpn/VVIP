...
echo -e "  ${LIGHT}• ${CYAN}Domain/Host         ${NC}=${BIGreen} $( cat /etc/xray/domain )"
...
echo -e "  ${LIGHT}• ${CYAN}Developer           ${NC}=${BIYellow} YogzVPN Tunneling ${NC}"
echo -e "${CYAN}┌────────────────────────────────────────────────────────────┐${NC}"
...
echo -e "${CYAN}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "   ${CYAN}[${LIGHT}01${CYAN}]${RED}•${NC} ${CYAN}SSH${NC}        ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}08${CYAN}]${RED}•${NC}${CYAN} BACKUP${NC}     ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "   ${CYAN}[${LIGHT}02${CYAN}]${RED}•${NC} ${CYAN}VMESS${NC}      ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}09${CYAN}]${RED}•${NC}${CYAN} SETTING${NC}    ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "   ${CYAN}[${LIGHT}03${CYAN}]${RED}•${NC} ${CYAN}VLESS${NC}      ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}10${CYAN}]${RED}•${NC}${CYAN} INFORMATION${NC}${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "   ${CYAN}[${LIGHT}04${CYAN}]${RED}•${NC} ${CYAN}TROJAN${NC}     ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}11${CYAN}]${RED}•${NC}${CYAN} ADD DOMAIN${NC} ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "   ${CYAN}[${LIGHT}05${CYAN}]${RED}•${NC} ${CYAN}SDSK${NC}       ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}12${CYAN}]${RED}•${NC}${CYAN} CERT XRAY${NC}  ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "   ${CYAN}[${LIGHT}06${CYAN}]${RED}•${NC} ${CYAN}UPDATE${NC}     ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}13${CYAN}]${RED}•${NC}${CYAN} AUTO REBOOT${NC}${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "   ${CYAN}[${LIGHT}07${CYAN}]${RED}•${NC} ${CYAN}INSTL UDP  ${NC}${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}         ${CYAN}[${LIGHT}14${CYAN}]${RED}•${NC}${CYAN} BOT${NC}        ${CYAN}[${NC}${BIYellow}MENU${NC}${CYAN}]${NC}"
echo -e "${CYAN}┌────────────────────────────────────────────────────────────┐${NC}"
