...
echo -e "  ${CYAN}[05]${NC} • ${BLUE}[${NC}${YELLOW} SSWS MENU ${NC}${BLUE}]${NC}            ${CYAN}[12]${NC} • ${BLUE}[${NC}${YELLOW} CERT XRAY ${NC}${BLUE}]${NC}    "
echo -e "  ${CYAN}[06]${NC} • ${BLUE}[${NC}${YELLOW} UPDATE MENU${NC}${BLUE}]${NC}           ${CYAN}[13]${NC} • ${BLUE}[${NC}${YELLOW} AUTO REBOOT ${NC}${BLUE}]${NC}     "
echo -e "  ${CYAN}[07]${NC} • ${BLUE}[${NC}${YELLOW} INSTALL UDP ${NC}${BLUE}]${NC}          ${CYAN}[14]${NC} • ${BLUE}[${NC}${YELLOW} MENU BOT ${NC}${BLUE}]${NC} "
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
