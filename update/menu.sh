...
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "   ${LIGHT}[01]${BLUE}•${NC} ${YELLOW}SSH${NC}        ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[08]${BLUE}•${NC}${YELLOW} BACKUP${NC}     ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${LIGHT}[02]${BLUE}•${NC} ${YELLOW}VMESS${NC}      ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[09]${BLUE}•${NC}${YELLOW} SETTING${NC}    ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${LIGHT}[03]${BLUE}•${NC} ${YELLOW}VLESS${NC}      ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[10]${BLUE}•${NC}${YELLOW} INFORMATION${NC}${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${LIGHT}[04]${BLUE}•${NC} ${YELLOW}TROJAN${NC}     ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[11]${BLUE}•${NC}${YELLOW} ADD DOMAIN${NC} ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${LIGHT}[05]${BLUE}•${NC} ${YELLOW}SDSK${NC}       ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[12]${BLUE}•${NC}${YELLOW} CERT XRAY${NC}  ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${LIGHT}[06]${BLUE}•${NC} ${YELLOW}UPDATE${NC}     ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[13]${BLUE}•${NC}${YELLOW} AUTO REBOOT${NC}${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "   ${LIGHT}[07]${BLUE}•${NC} ${YELLOW}INSTALL UDP${NC}${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}         ${LIGHT}[14]${BLUE}•${NC}${YELLOW} BOT${NC}        ${BLUE}[${NC}${CYAN}MENU${NC}${BLUE}]${NC}"
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
