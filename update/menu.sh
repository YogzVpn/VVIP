...
echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
echo -e "  ${CYAN}[01]${NC} • ${BLUE}[${NC}${YELLOW} SSH MENU ${NC}${RED}]${NC}             ${CYAN}[08]${NC} • ${BLUE}[${NC}${YELLOW} BACKUP MENU ${NC}${RED}]${NC} "
echo -e "  ${CYAN}[02]${NC} • ${BLUE}[${NC}${YELLOW} VMESS MENU ${NC}${RED}]${NC}           ${CYAN}[09]${NC} • ${BLUE}[${NC}${YELLOW} SETTING MENU${NC}${RED}]${NC}  "
echo -e "  ${CYAN}[03]${NC} • ${BLUE}[${NC}${YELLOW} VLESS MENU ${NC}${RED}]${NC}           ${CYAN}[10]${NC} • ${BLUE}[${NC}${YELLOW} INFORMATION ${NC}${RED}]${NC}     "
echo -e "  ${CYAN}[04]${NC} • ${BLUE}[${NC}${YELLOW} TROJAN MENU ${NC}${RED}]${NC}          ${CYAN}[11]${NC} • ${BLUE}[${NC}${YELLOW} ADD HOST/DOMAIN ${NC}${RED}]${NC}    "
echo -e "  ${CYAN}[05]${NC} • ${BLUE}[${NC}${YELLOW} SSWS MENU ${NC}${RED}]${NC}            ${CYAN}[12]${NC} • ${BLUE}[${NC}${YELLOW} CERT XRAY ${NC}${RED}]${NC}    "
echo -e "  ${CYAN}[06]${NC} • ${BLUE}[${NC}${YELLOW} UPDATE MENU${NC}${RED}]${NC}           ${CYAN}[13]${NC} • ${BLUE}[${NC}${YELLOW} AUTO REBOOT ${NC}${RED}]${NC}     "
echo -e "  ${CYAN}[07]${NC} • ${BLUE}[${NC}${YELLOW} INSTALL UDP ${NC}${RED}]${NC}          ${CYAN}[14]${NC} • ${BLUE}[${NC}${YELLOW} MENU BOT ${NC}${RED}]${NC} "
echo -e "${RED}┌────────────────────────────────────────────────────────────┐${NC}"
