...
MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/YogzVpn/izinvps/main/ip | grep $MYIP | awk '{print $2}')
...
LLatest=`date`
Get_Data () {
git clone https://github.com/YogzVpn/backup.git /root/user-backup/ &> /dev/null
}
...
link="https://raw.githubusercontent.com/YogzVpn/backup/main/$NameUser/$NameUser.zip"
sleep 1
